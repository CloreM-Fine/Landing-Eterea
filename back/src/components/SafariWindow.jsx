...
// Icone in stile Apple per le sezioni
const sectionIcons = {
  'Eterea': Home,
  'Contatti': Phone,
  'Chi siamo': Users,
          ...
          >
            ...
            <div className="mb-4">
              ...
              <div className="space-y-0.5">
                <SidebarItem icon={Home} label="Eterea" isActive={currentView.title === 'Eterea'} isDark={isDark} colors={colors} onClick={() => onNavigate && onNavigate('Eterea')} />
                <SidebarItem icon={Phone} label="Contatti" isActive={currentView.title === 'Contatti'} isDark={isDark} colors={colors} onClick={() => onNavigate && onNavigate('Contatti')} />
                <SidebarItem icon={Users} label="Chi siamo" isActive={currentView.title === 'Chi Siamo'} isDark={isDark} colors={colors} onClick={() => onNavigate && onNavigate('Chi siamo')} />
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="space-y-0.5">
                <SidebarItem icon={Smartphone} label="App" isActive={currentView.title === 'App'} isDark={isDark} colors={colors} onClick={() => onNavigate && onNavigate('App')} />
                <SidebarItem icon={Palette} label="Grafica" isActive={currentView.title === 'Grafica'} isDark={isDark} colors={colors} onClick={() => onNavigate && onNavigate('Grafica')} />
                <SidebarItem icon={Box} label="Progettazione 3D" isActive={currentView.title === 'Progettazione 3D'} isDark={isDark} colors={colors} onClick={() => onNavigate && onNavigate('Progettazione 3D')} />
                <SidebarItem icon={Camera} label="Shooting" isActive={currentView.title === 'Shooting'} isDark={isDark} colors={colors} onClick={() => onNavigate && onNavigate('Shooting')} />
                <SidebarItem icon={Globe} label="Siti Web" isActive={currentView.title === 'Siti Web'} isDark={isDark} colors={colors} onClick={() => onNavigate && onNavigate('Siti Web')} />
                <SidebarItem icon={Share} label="Social Media" isActive={currentView.title === 'Social Media'} isDark={isDark} colors={colors} onClick={() => onNavigate && onNavigate('Social Media')} />
                <SidebarItem icon={Clapperboard} label="Video" isActive={currentView.title === 'Video'} isDark={isDark} colors={colors} onClick={() => onNavigate && onNavigate('Video')} />
              </div>
            </div>
          </div>
        )}
